...
function HomeCtrl($http) {
    ...
    vm.searchNews = function() {
        ...
        $http.post('/searchNews', { articles: vm.newsArticles.articles })
            .then(function(data) {
                vm.article = data.data.response.results;
                //console.log(vm.article)
            })
    }
    vm.searchNews();
    //NY Times 
    vm.searchNYT = function() {

        $http.get('/searchNYT', { articles: vm.nyArticles.articles })
            .then(function(data) {
                vm.articleNY = data.data.response.docs;
                console.log(vm.articleNY)
            })
    }
    vm.searchNYT();
